...
class Panitia extends CI_Controller
{
    ...
    public function jumlah()
    {
        ...
        // $data['dbklsma'] = $this->panitia_model->getkls_ma();
        // $data['dbklssmp'] = $this->panitia_model->getkls_smp();
        // $data['dbklssmk'] = $this->panitia_model->getkls_smk();
    ...
    public function residu($par)
    {
        ...
        $data['content']    = 'panitia/residuview';
    ...
    public function nonaktif($par)
    {
        ...
        $data['content']    = 'panitia/nonaktifview';
    ...
    public function updatesetting()
    {
        ...
        redirect('panitia/setting', 'refresh');
    }
    ...
    public function addsmpmts()
    {
        ...
        $this->session->set_flashdata('pesan', "{icon: 'success', title: 'Alhamdulillah!',text: 'Tambah data berhasil'}");
        redirect('panitia/smpmts', 'refresh');
    }
    ...
    public function export($par)
    {
        ...
        // $siswa = $this->panitia_model->getmts();
