...
class Mgm extends CI_Controller
{
    ...
    public function jumlah()
    {
        ...
        // $data['dbklsma'] = $this->mgm_model->getkls_ma();
        // $data['dbklssmp'] = $this->mgm_model->getkls_smp();
        // $data['dbklssmk'] = $this->mgm_model->getkls_smk();
        $data['content'] = 'mgm/jumlah';
    ...
    public function editsave($par, $id)
    {
        ...
        // redirect('mgm/'.$uricek.'/'.$par, 'refresh');
        redirect('mgm/data/' . $par, 'refresh');
    }
    ...
    public function adduser_pes()
    {
        ...
        if ($jmlnik != 0) {
            ...
            redirect('mgm/user_peserta', 'refresh');
        } else {
            $data                     = $this->input->post();
            $data['jabatan']         = 'user';
            $data['status']         = 'AKTIF';
