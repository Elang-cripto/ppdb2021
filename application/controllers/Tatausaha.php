...
class Tatausaha extends CI_Controller {
	...
	public function __construct()
	{
		...
		if($this->session->userdata('jabatan')!="tatausaha")
		{
	...
	public function index()
	{
		...
		$this->load->view('tatausaha/dasboard',$data);
	}
...
//==============================================================
	...
	public function jumlah()
	{
		...
		$this->load->view('tatausaha/jumlah',$data);
	}
//-------------------------------------------------------------

	public function master()
	{
		$this->load->view('tatausaha/master');
	}
...
//-------------------------------------------------------------
	public function user()
	{
		...
		$this->load->view('tatausaha/user',$data);
	}
	...
	public function edituser($id)
	{
		...
		$this->load->view('tatausaha/user-edit',$data);
	}

	public function adduser()
	{
		$data['cats'] 	= $this->admin_model->getkls();
		$this->load->view('tatausaha/user-form',$data);
	}
		...
		if ($this->form_validation->run()==true)
        {
			...
			$this->load->library('upload', $config);
				...
				if ( ! $this->upload->do_upload('foto'))
				{
					...
					$this->load->view('tatausaha/user-form',$ambil);
					...
					redirect('tatausaha/user',$ambil);
					// $ambil['dbuser'] = $this->admin_model->getuser();
					// $this->load->view('tatausaha/user',$ambil);
		}
		else
		{
			$ambil['dbuser'] = $this->admin_model->getuser();
	...
	public function updateuser()
	{
		...
		if ($this->form_validation->run()==true)
        {
			...
			{
				$error = array('error' => $this->upload->display_errors());
				$this->load->view('tatausaha/user-edit', $error);
			}
				...
				redirect('tatausaha/edituser/'.base64_encode($id));
		}
		else
		{
			$id = $this->input->post('id');
...
//-------------------------------------------------------------
	public function klsmts()
	{
		...
		$this->load->view('tatausaha/klsmts',$data);
	}
	...
	public function klsma()
	{
		...
		$this->load->view('tatausaha/klsma',$data);
	}
	...
	public function klssmp()
	{
		...
		$this->load->view('tatausaha/klssmp',$data);
	}
	...
	public function klssmk()
	{
		...
		$this->load->view('tatausaha/klssmk',$data);
	}
...
//-------------------------------------------------------------
	public function profil($id)
	{
		...
		$this->load->view('tatausaha/profill',$data);
	}
...
//-------------------------------------------------------------
	public function editmts($id)
	{
		$data['dbmts'] = $this->admin_model->getByIdmts($id);
		$data['cats'] = $this->admin_model->getkls_mts();
		$this->load->view('tatausaha/edit-mts',$data);
	}
	...
	public function editsmp($id)
	{
		$data['dbsmp'] = $this->admin_model->getByIdsmp($id);
		$data['cats'] = $this->admin_model->getkls_smp();
		$this->load->view('tatausaha/edit-smp',$data);
	}
	...
	public function editma($id)
	{
		$data['dbma'] = $this->admin_model->getByIdma($id);
		$data['cats'] = $this->admin_model->getkls_ma();
		$this->load->view('tatausaha/edit-ma',$data);
	}
	...
	public function editsmk($id)
	{
		$data['dbsmk'] = $this->admin_model->getByIdsmk($id);
		$data['cats'] = $this->admin_model->getkls_smk();
		$this->load->view('tatausaha/edit-smk',$data);
	}
...
//-------------------------------------------------------------
	...
	public function savekls()
	{
		...
		$this->session->set_flashdata('pesan', "{icon: 'success', title: 'Alhamdulillah',text: 'Kelas baru berhasil ditambah'}");
			if( $data['par'] =="mts"){ 
				redirect('tatausaha/klsmts');
			} else if($data['par']=="smp"){
				redirect('tatausaha/klssmp');
			} else if($data['par']=="ma"){
				redirect('tatausaha/klsma');
			} else if($data['par']=="smk"){
				redirect('tatausaha/klssmk');
			}
	}
...
// =====================================================================================================================================
	...
	{
		$this->load->view('tatausaha/upload-mts');
	}

	public function uploadma()
	{
		$this->load->view('tatausaha/upload-ma');
	}

	public function uploadsmp()
	{
		$this->load->view('tatausaha/upload-smp');
	}

	public function uploadsmk()
	{
		$this->load->view('tatausaha/upload-smk');
	}
...
// =====================================================================================================================================
	...
	public function updatemts()
	{
		...
		if ($this->form_validation->run()==true)
        {
			...
			{
				$error = array('error' => $this->upload->display_errors());
				$this->load->view('tatausaha/edit-mts', $error);
			}
			 	$id = $this->input->post('id');
	...
	public function updatesmp()
	{
		...
		if ($this->form_validation->run()==true)
        {
			...
			{
				$error = array('error' => $this->upload->display_errors());
				$this->load->view('tatausaha/edit-smp', $error);
			}
			 	$id = $this->input->post('id');
			 	$data['nis'] = $this->input->post('nis');
			 	$data['nisn'] = $this->input->post('nisn');
	...
	public function updatema()
	{
		...
		if ($this->form_validation->run()==true)
        {
			...
			{
				$error = array('error' => $this->upload->display_errors());
				$this->load->view('tatausaha/edit-ma', $error);
			}
			 	$id = $this->input->post('id');
			 	$data['nis'] = $this->input->post('nis');
			 	$data['nisn'] = $this->input->post('nisn');
	...
	public function updatesmk()
	{
		...
		if ($this->form_validation->run()==true)
        {
			...
			{
				$error = array('error' => $this->upload->display_errors());
				$this->load->view('tatausaha/edit-smk', $error);
			}
			 	$id = $this->input->post('id');
			 	$data['nis'] = $this->input->post('nis');
			 	$data['nisn'] = $this->input->post('nisn');
...
// =====================================================================================================================================
	...
	public function export_mts()
	{
		...
		foreach($siswa as $data){ // Lakukan looping pada variabel siswa
			...
			// $excel->setActiveSheetIndex(0)->setCellValue('E'.$numrow, $data->kelas_aktf);
...
// =====================================================================================================================================
	...
	public function form_mts()
	{
		...
		$this->load->view('tatausaha/upload-mts',$data);
	}
	...
	public function form_ma()
	{
		...
		$this->load->view('tatausaha/upload-ma',$data);
	}
	...
	public function form_smp()
	{
		...
		$this->load->view('tatausaha/upload-smp',$data);
	}
	...
	public function form_smk()
	{
		...
		$this->load->view('tatausaha/upload-smk',$data);
	}
