            ...
            <div class="card card-<?php echo $warna; ?>">
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="almt_skl" class="form-control" id="almt_skl" value="<?php echo $data->almt_skl; ?>" disabled>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="jns_masuk" class="col-sm-4 col-form-label">JENIS PENDAFTARAN</label>
                  <div class="col-sm-8">
                    <select type="text" name="jns_masuk" id="jns_masuk" class="form-control select2" disabled>
                      <option value="Siswa Baru" <?php if ($data->jns_masuk == "Siswa Baru") {
                                                    echo "selected";
                                                  } ?>>Siswa Baru</option>
                      <option value="Pindahan" <?php if ($data->jns_masuk == "Pindahan") {
                                                  echo "selected";
                                                } ?>>Pindahan</option>
                      <option value="Kembali Bersekolah" <?php if ($data->jns_masuk == "Kembali Bersekolah") {
                                                            echo "selected";
