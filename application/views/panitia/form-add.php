        ...
        <div class="col-md-6">
          ...
          <div class="card card-<?php echo $warna; ?>">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                <i>
                  <p class="text-primary">Jika sekolah pilihan tidak ditemukan maka silahkan menambahkan baru dari menu "Sekolah Asal" dan input data sekolah sesuai nama di Referensi</p>
                </i>
              </div>
            </div>
          </div>
