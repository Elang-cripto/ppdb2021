  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- form start -->
        <form method="post" action="<?php echo base_url(); ?>walikelas/updatesmp" enctype="multipart/form-data">
            <!-- Horizontal Form -->
        <div class="row">
            <div class="col-md-3">
              ...
              <div class="card card-warning card-outline">
                <div class="card-body box-profile">
                  ...
                  <ul class="list-group list-group-unbordered mb-3">
                    ...
                    <li class="list-group-item">
                      <b>ROMBEL</b> <a class="float-right"><h6><span class="badge bg-info">Kelas <?php echo $dbsmp->kelas_aktf; ?></span></h6></a>
                    </li>
                    <li class="list-group-item">
                      <b>UMUR</b> 
                      <a class="float-right">
                ...
                <div class="card-body">
                  <strong><i class="fas fa-book mr-1"></i> Pendidikan</strong>
                    <p class="text-muted">
                      ...
                      SMP/MTS : SMP PLUS AL AMIEN AMBULU
                    </p>
                  <hr>

                  <strong><i class="fas fa-map-marker-alt mr-1"></i> Alamat</strong>
                    <p class="text-muted"><?php echo $dbsmp->alamat; ?>,
                      Dsn. <?php echo $dbsmp->dusun; ?>,
                      Ds. <?php echo $dbsmp->kelurahan; ?>,
                      Kec. <?php echo $dbsmp->kecamatan; ?>,
                      Kab. <?php echo $dbsmp->kabupaten; ?>
                    </p>
                  <hr>
                    ...
                    <div class="card-body">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          ...
                          <input type="text" name="nis" class="form-control" id="Nis" disabled value="<?php echo $dbsmp->nis; ?>" >
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="Nisn" class="col-sm-4 col-form-label">NISN</label>
                        <div class="col-sm-8">
                          <input type="text" name="nisn" class="form-control" id="Nisn" placeholder="Sesuai Ijazah Sebelumnya" value="<?php echo $dbsmp->nisn; ?>">
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="nik" class="form-control" id="nik" placeholder="35xxxxxxxxxxxxxx" value="<?php echo $dbsmp->nik; ?>" required>
                        </div>
                      </div>
                      <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <div class="card-body">                   
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="dusun" class="form-control" id="Dusun" placeholder="Dusun" value="<?php echo $dbsmp->dusun; ?>" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="Kelurahan" class="col-sm-4 col-form-label">KELURAHAN</label>
                        <div class="col-sm-8">
                          <input type="text" name="kelurahan" class="form-control" id="Kelurahan" placeholder="Kelurahan" value="<?php echo $dbsmp->kelurahan; ?>" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="Kecamatan" class="col-sm-4 col-form-label">KECAMATAN</label>
                        <div class="col-sm-8">
                          <input type="text" name="kecamatan" class="form-control" id="Kecamatan" placeholder="Kecamatan" value="<?php echo $dbsmp->kecamatan; ?>" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="Kabupaten" class="col-sm-4 col-form-label">KABUPATEN</label>
                        <div class="col-sm-8">
                          <input type="text" name="kabupaten" class="form-control" id="Kabupaten" placeholder="Kabupaten" value="<?php echo $dbsmp->kabupaten; ?>" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="Propinsi" class="col-sm-4 col-form-label">PROPINSI</label>
                        <div class="col-sm-8">
                          <input type="text" name="propinsi" class="form-control" id="Propinsi" placeholder="Propinsi" value="<?php echo $dbsmp->propinsi; ?>" required>
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <select type="text" name="sts_tinggal" id="Status Tinggal"  class="form-control select2" >
                          <option value="" <?php if($dbsmp->sts_tinggal==""){echo "selected";} ?>>Tidak Diketahui</option>
                          <option value="Milik Sendiri" <?php if($dbsmp->sts_tinggal=="Milik Sendiri"){echo "selected";} ?>>Milik Sendiri</option>
                          <option value="Rumah Orang Tua" <?php if($dbsmp->sts_tinggal=="Rumah Orang Tua"){echo "selected";} ?>>Rumah Orang Tua</option>
                          <option value="Rumah Saudara/Kerabat" <?php if($dbsmp->sts_tinggal=="Rumah Saudara/Kerabat"){echo "selected";} ?>>Rumah Saudara/Kerabat</option>
                          <option value="Rumah Dinas" <?php if($dbsmp->sts_tinggal=="Rumah Dinas"){echo "selected";} ?>>Rumah Dinas</option>
                          <option value="Sewa/kontrak" <?php if($dbsmp->sts_tinggal=="Sewa/kontrak"){echo "selected";} ?>>Sewa/kontrak</option>
                          <option value="Lainnya" <?php if($dbsmp->sts_tinggal=="Lainnya"){echo "selected";} ?>>Lainnya</option>
                        </select>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <select type="text" name="alat_trans" id="alat_trans"  class="form-control select2">
                              ...
                              <option value="Jalan kaki" <?php if($dbsmp->alat_trans=="Jalan kaki"){echo "selected";} ?>>Jalan kaki</option>
                              <option value="Angkutan umum/bus/pete-pete" <?php if($dbsmp->alat_trans=="Angkutan umum/bus/pete-pete"){echo "selected";} ?>>Angkutan umum/bus/pete-pete</option>
                              <option value="Mobil/bus antar jemput" <?php if($dbsmp->alat_trans=="Mobil/bus antar jemput"){echo "selected";} ?>>Mobil/bus antar jemput</option>
                              <option value="Kereta api" <?php if($dbsmp->alat_trans=="Kereta api"){echo "selected";} ?>>Kereta api</option>
                              <option value="Ojek" <?php if($dbsmp->alat_trans=="Ojek"){echo "selected";} ?>>Ojek</option>
                              <option value="Andong/bendi/sado/dokar/delman/becak" <?php if($dbsmp->alat_trans=="Andong/bendi/sado/dokar/delman/becak"){echo "selected";} ?>>Andong/bendi/sado/dokar/delman/becak</option>
                              <option value="Perahu penyeberangan/rakit/getek" <?php if($dbsmp->alat_trans=="Perahu penyeberangan/rakit/getek"){echo "selected";} ?>>Perahu penyeberangan/rakit/getek</option>
                              <option value="Kuda" <?php if($dbsmp->alat_trans=="Kuda"){echo "selected";} ?>>Kuda</option>
                              <option value="Sepeda" <?php if($dbsmp->alat_trans=="Sepeda"){echo "selected";} ?>>Sepeda</option>
                              <option value="Sepeda motor" <?php if($dbsmp->alat_trans=="Sepeda motor"){echo "selected";} ?>>Sepeda motor</option>
                              <option value="obil pribadi" <?php if($dbsmp->alat_trans=="obil pribadi"){echo "selected";} ?>>Mobil pribadi</option>
                              <option value="Lainnya" <?php if($dbsmp->alat_trans=="Lainnya"){echo "selected";} ?>>Lainnya</option>
                            </select>
                        </div>
                      </div>
                      <div class="form-group row">
                  ...
                  <div class="card card-warning">
                    ...
                    <div class="card-body">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="no_kk" class="form-control" id="no_kk" value="<?php echo $dbsmp->no_kk; ?>" placeholder="Sesuai Kartu keluarga" required>
                        </div>
                      </div>         
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="tlahir_ayh" class="form-control" id="tlahir_ayh" placeholder="Kota Lahir" value="<?php echo $dbsmp->tlahir_ayh; ?>">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="lahir_ayh" class="col-sm-4 col-form-label">TANGGAL LAHIR AYAH</label>
                        <div class="col-sm-8"> 
                            <input type="date" name="lahir_ayh" class="form-control" value="<?php echo $dbsmp->lahir_ayh; ?>" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask>
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <select type="text" name="kerja_ayh" id="kerja_ayh"  class="form-control select2">
                            <option value="" <?php if($dbsmp->kerja_ayh==""){echo "selected";} ?>>Tidak Diketahui</option>
                            <option value="Tidak bekerja" <?php if($dbsmp->kerja_ayh=="Tidak bekerja"){echo "selected";} ?>>Tidak bekerja</option>
                            <option value="Nelayan" <?php if($dbsmp->kerja_ayh=="Nelayan"){echo "selected";} ?>>Nelayan</option>
                            <option value="Petani" <?php if($dbsmp->kerja_ayh=="Petani"){echo "selected";} ?>>Petani</option>
                            <option value="Peternak" <?php if($dbsmp->kerja_ayh=="Peternak"){echo "selected";} ?>>Peternak</option>
                            <option value="PNS/TNI/POLRI" <?php if($dbsmp->kerja_ayh=="PNS/TNI/POLRI"){echo "selected";} ?>>PNS/TNI/POLRI</option>
                            <option value="Karyawan Swasta" <?php if($dbsmp->kerja_ayh=="Karyawan Swasta"){echo "selected";} ?>>Karyawan Swasta</option>
                            <option value="Pedagang Kecil" <?php if($dbsmp->kerja_ayh=="Pedagang Kecil"){echo "selected";} ?>>Pedagang Kecil</option>
                            <option value="Pedagang Besar" <?php if($dbsmp->kerja_ayh=="Pedagang Besar"){echo "selected";} ?>>Pedagang Besar</option>
                            <option value="Wiraswasta" <?php if($dbsmp->kerja_ayh=="Wiraswasta"){echo "selected";} ?>>Wiraswasta</option>
                            <option value="Wirausaha" <?php if($dbsmp->kerja_ayh=="Wirausaha"){echo "selected";} ?>>Wirausaha</option>
                            <option value="Buruh" <?php if($dbsmp->kerja_ayh=="Buruh"){echo "selected";} ?>>Buruh</option>
                            <option value="Pensiunan" <?php if($dbsmp->kerja_ayh=="Pensiunan"){echo "selected";} ?>>Pensiunan</option>
                            <option value="Guru" <?php if($dbsmp->kerja_ayh=="Guru"){echo "selected";} ?>>Guru</option>
                          </select>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <select type="text" name="hasil_ayh" id="hasil_ayh"  class="form-control select2">
                            <option value="" <?php if($dbsmp->hasil_ayh==""){echo "selected";} ?>>Tidak Diketahui</option>
                            <option value="Kurang dari Rp. 500,000" <?php if($dbsmp->hasil_ayh=="Kurang dari Rp. 500,000"){echo "selected";} ?>>Kurang dari Rp. 500,000</option>
                            <option value="Rp. 500,000 - Rp. 999,999" <?php if($dbsmp->hasil_ayh=="Rp. 500,000 - Rp. 999,999"){echo "selected";} ?>>Rp. 500,000 - Rp. 999,999</option>
                            <option value="Rp. 1,000,000 - Rp. 1,999,999" <?php if($dbsmp->hasil_ayh=="Rp. 1,000,000 - Rp. 1,999,999"){echo "selected";} ?>>Rp. 1,000,000 - Rp. 1,999,999</option>
                            <option value="Rp. 2,000,000 - Rp. 4,999,999" <?php if($dbsmp->hasil_ayh=="Rp. 2,000,000 - Rp. 4,999,999"){echo "selected";} ?>>Rp. 2,000,000 - Rp. 4,999,999</option>
                            <option value="Rp. 5,000,000 - Rp. 20,000,000" <?php if($dbsmp->hasil_ayh=="Rp. 5,000,000 - Rp. 20,000,000"){echo "selected";} ?>>Rp. 5,000,000 - Rp. 20,000,000</option>
                            <option value="Lebih dari Rp. 20,000,000" <?php if($dbsmp->hasil_ayh=="Lebih dari Rp. 20,000,000"){echo "selected";} ?>>Lebih dari Rp. 20,000,000</option>
                            <option value="Tidak Berpenghasilan" <?php if($dbsmp->hasil_ayh=="Tidak Berpenghasilan"){echo "selected";} ?>>Tidak Berpenghasilan</option>
                          </select>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card card-warning">
                    ...
                    <div class="card-body">              
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="tlahir_ibu" class="form-control" id="tlahir_ibu" placeholder="Kota Lahir" value="<?php echo $dbsmp->tlahir_ibu; ?>">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="lahir_ibu" class="col-sm-4 col-form-label">TANGGAL LAHIR IBU</label>
                        <div class="col-sm-8"> 
                            <input type="date" name="lahir_ibu" class="form-control" value="<?php echo $dbsmp->lahir_ibu; ?>" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask>
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <select type="text" name="kerja_ibu" id="kerja_ibu"  class="form-control select2">
                            <option value="" <?php if($dbsmp->kerja_ibu==""){echo "selected";} ?>>Tidak Diketahui</option>
                            <option value="Tidak bekerja" <?php if($dbsmp->kerja_ibu=="Tidak bekerja"){echo "selected";} ?>>Tidak bekerja</option>
                            <option value="Nelayan" <?php if($dbsmp->kerja_ibu=="Nelayan"){echo "selected";} ?>>Nelayan</option>
                            <option value="Petani" <?php if($dbsmp->kerja_ibu=="Petani"){echo "selected";} ?>>Petani</option>
                            <option value="Peternak" <?php if($dbsmp->kerja_ibu=="Peternak"){echo "selected";} ?>>Peternak</option>
                            <option value="PNS/TNI/POLRI" <?php if($dbsmp->kerja_ibu=="PNS/TNI/POLRI"){echo "selected";} ?>>PNS/TNI/POLRI</option>
                            <option value="Karyawan Swasta" <?php if($dbsmp->kerja_ibu=="Karyawan Swasta"){echo "selected";} ?>>Karyawan Swasta</option>
                            <option value="Pedagang Kecil" <?php if($dbsmp->kerja_ibu=="Pedagang Kecil"){echo "selected";} ?>>Pedagang Kecil</option>
                            <option value="Pedagang Besar" <?php if($dbsmp->kerja_ibu=="Pedagang Besar"){echo "selected";} ?>>Pedagang Besar</option>
                            <option value="Wiraswasta" <?php if($dbsmp->kerja_ibu=="Wiraswasta"){echo "selected";} ?>>Wiraswasta</option>
                            <option value="Wirausaha" <?php if($dbsmp->kerja_ibu=="Wirausaha"){echo "selected";} ?>>Wirausaha</option>
                            <option value="Buruh" <?php if($dbsmp->kerja_ibu=="Buruh"){echo "selected";} ?>>Buruh</option>
                            <option value="Pensiunan" <?php if($dbsmp->kerja_ibu=="Pensiunan"){echo "selected";} ?>>Pensiunan</option>
                            <option value="Guru" <?php if($dbsmp->kerja_ibu=="Guru"){echo "selected";} ?>>Guru</option>
                          </select>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <select type="text" name="hasil_ibu" id="hasil_ibu"  class="form-control select2">
                            <option value="" <?php if($dbsmp->hasil_ibu==""){echo "selected";} ?>>Tidak Diketahui</option>
                            <option value="Kurang dari Rp. 500,000" <?php if($dbsmp->hasil_ibu=="Kurang dari Rp. 500,000"){echo "selected";} ?>>Kurang dari Rp. 500,000</option>
                            <option value="Rp. 500,000 - Rp. 999,999" <?php if($dbsmp->hasil_ibu=="Rp. 500,000 - Rp. 999,999"){echo "selected";} ?>>Rp. 500,000 - Rp. 999,999</option>
                            <option value="Rp. 1,000,000 - Rp. 1,999,999" <?php if($dbsmp->hasil_ibu=="Rp. 1,000,000 - Rp. 1,999,999"){echo "selected";} ?>>Rp. 1,000,000 - Rp. 1,999,999</option>
                            <option value="Rp. 2,000,000 - Rp. 4,999,999" <?php if($dbsmp->hasil_ibu=="Rp. 2,000,000 - Rp. 4,999,999"){echo "selected";} ?>>Rp. 2,000,000 - Rp. 4,999,999</option>
                            <option value="Rp. 5,000,000 - Rp. 20,000,000" <?php if($dbsmp->hasil_ibu=="Rp. 5,000,000 - Rp. 20,000,000"){echo "selected";} ?>>Rp. 5,000,000 - Rp. 20,000,000</option>
                            <option value="Lebih dari Rp. 20,000,000" <?php if($dbsmp->hasil_ibu=="Lebih dari Rp. 20,000,000"){echo "selected";} ?>>Lebih dari Rp. 20,000,000</option>
                            <option value="Tidak Berpenghasilan" <?php if($dbsmp->hasil_ibu=="Tidak Berpenghasilan"){echo "selected";} ?>>Tidak Berpenghasilan</option>
                          </select>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card card-warning">
                    ...
                    <div class="card-body">              
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="tlahir_wl" class="form-control" id="tlahir_wl" placeholder="Kota Lahir" value="<?php echo $dbsmp->tlahir_wl; ?>">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="lahir_wl" class="col-sm-4 col-form-label">TANGGAL LAHIR WALI</label>
                        <div class="col-sm-8"> 
                            <input type="date" name="lahir_wl" class="form-control" value="<?php echo $dbsmp->lahir_wl; ?>" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask>
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <select type="text" name="kerja_wl" id="kerja_wl"  class="form-control select2">
                            <option value="" <?php if($dbsmp->kerja_wl==""){echo "selected";} ?>>Tidak Diketahui</option>
                            <option value="Tidak bekerja" <?php if($dbsmp->kerja_wl=="Tidak bekerja"){echo "selected";} ?>>Tidak bekerja</option>
                            <option value="Nelayan" <?php if($dbsmp->kerja_wl=="Nelayan"){echo "selected";} ?>>Nelayan</option>
                            <option value="Petani" <?php if($dbsmp->kerja_wl=="Petani"){echo "selected";} ?>>Petani</option>
                            <option value="Peternak" <?php if($dbsmp->kerja_wl=="Peternak"){echo "selected";} ?>>Peternak</option>
                            <option value="PNS/TNI/POLRI" <?php if($dbsmp->kerja_wl=="PNS/TNI/POLRI"){echo "selected";} ?>>PNS/TNI/POLRI</option>
                            <option value="Karyawan Swasta" <?php if($dbsmp->kerja_wl=="Karyawan Swasta"){echo "selected";} ?>>Karyawan Swasta</option>
                            <option value="Pedagang Kecil" <?php if($dbsmp->kerja_wl=="Pedagang Kecil"){echo "selected";} ?>>Pedagang Kecil</option>
                            <option value="Pedagang Besar" <?php if($dbsmp->kerja_wl=="Pedagang Besar"){echo "selected";} ?>>Pedagang Besar</option>
                            <option value="Wiraswasta" <?php if($dbsmp->kerja_wl=="Wiraswasta"){echo "selected";} ?>>Wiraswasta</option>
                            <option value="Wirausaha" <?php if($dbsmp->kerja_wl=="Wirausaha"){echo "selected";} ?>>Wirausaha</option>
                            <option value="Buruh" <?php if($dbsmp->kerja_wl=="Buruh"){echo "selected";} ?>>Buruh</option>
                            <option value="Pensiunan" <?php if($dbsmp->kerja_wl=="Pensiunan"){echo "selected";} ?>>Pensiunan</option>
                            <option value="Guru" <?php if($dbsmp->kerja_wl=="Guru"){echo "selected";} ?>>Guru</option>
                          </select>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <select type="text" name="hasil_wl" id="hasil_wl"  class="form-control select2">
                            <option value="" <?php if($dbsmp->hasil_wl==""){echo "selected";} ?>>Tidak Diketahui</option>
                            <option value="Kurang dari Rp. 500,000" <?php if($dbsmp->hasil_wl=="Kurang dari Rp. 500,000"){echo "selected";} ?>>Kurang dari Rp. 500,000</option>
                            <option value="Rp. 500,000 - Rp. 999,999" <?php if($dbsmp->hasil_wl=="Rp. 500,000 - Rp. 999,999"){echo "selected";} ?>>Rp. 500,000 - Rp. 999,999</option>
                            <option value="Rp. 1,000,000 - Rp. 1,999,999" <?php if($dbsmp->hasil_wl=="Rp. 1,000,000 - Rp. 1,999,999"){echo "selected";} ?>>Rp. 1,000,000 - Rp. 1,999,999</option>
                            <option value="Rp. 2,000,000 - Rp. 4,999,999" <?php if($dbsmp->hasil_wl=="Rp. 2,000,000 - Rp. 4,999,999"){echo "selected";} ?>>Rp. 2,000,000 - Rp. 4,999,999</option>
                            <option value="Rp. 5,000,000 - Rp. 20,000,000" <?php if($dbsmp->hasil_wl=="Rp. 5,000,000 - Rp. 20,000,000"){echo "selected";} ?>>Rp. 5,000,000 - Rp. 20,000,000</option>
                            <option value="Lebih dari Rp. 20,000,000" <?php if($dbsmp->hasil_wl=="Lebih dari Rp. 20,000,000"){echo "selected";} ?>>Lebih dari Rp. 20,000,000</option>
                            <option value="Tidak Berpenghasilan" <?php if($dbsmp->hasil_wl=="Tidak Berpenghasilan"){echo "selected";} ?>>Tidak Berpenghasilan</option>
                          </select>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card card-warning">
                    ...
                    <div class="card-body">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                          <input type="text" name="kelas_7" class="form-control" id="kelas_7" placeholder="7-X" value="<?php echo $dbsmp->kelas_7; ?>" disabled>
                        </div>
                        <div class="col-sm-2">
                          <input type="text" name="kelas_8" class="form-control" id="kelas_8" placeholder="8-X"  value="<?php echo $dbsmp->kelas_8; ?>" disabled>
                        </div>
                        <div class="col-sm-2">
                          <input type="text" name="kelas_9" class="form-control" id="kelas_9" placeholder="9-X"  value="<?php echo $dbsmp->kelas_9; ?>" disabled>
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="kelas_dig" class="form-control" id="kelas_dig" value="<?php echo $dbsmp->kelas_dig; ?>" disabled>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <select type="text" name="status" id="status" class="form-control select2">
                            ...
                            <option value="PENGAJUAN MUTASI" <?php if($dbsmp->status=="PENGAJUAN MUTASI"){echo "selected";} ?>>PENGAJUAN MUTASI</option>
                            <option hidden value="PROSES MUTASI" <?php if($dbsmp->status=="PROSES MUTASI"){echo "selected";} ?>>PROSES MUTASI</option>
                            <option hidden value="NON AKTIF" <?php if($dbsmp->status=="NON AKTIF"){echo "selected";} ?>>NON AKTIF</option>
                          </select>
                        </div>
                      </div>
