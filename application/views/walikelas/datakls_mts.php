                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td align="center">
                      ...
                      <a data-toggle='tooltip' data-placement='top' title='Edit' href="<?php echo base_url(); ?>walikelas/editmts/<?php echo $row->id; ?>" class="btn btn-info btn-sm"><i class="fa fa-user-edit"></i></a>
                    </td>
                  </tr>
                    <?php  endforeach; ?>
                  </tbody>
