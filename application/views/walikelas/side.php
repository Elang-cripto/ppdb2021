  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="<?php echo base_url($role) ?>/datakls<?php echo $par; ?>/<?php echo $kelas; ?>" class="nav-link <?php if($this->uri->segment(2)=="datakls<?php echo $par; ?>"){echo "active";}?>">
            <i class="nav-icon fas fa-users"></i><p>Peserta Didik</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="<?php echo base_url($role) ?>/cekdata/<?php echo $par; ?>/<?php echo $kelas; ?>" class="nav-link <?php if($this->uri->segment(2)=="cekdata<?php echo $par; ?>"){echo "active";}?>">
            <i class="nav-icon fas fa-user-check"></i><p>Verivikasi Data</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="<?php echo base_url($role) ?>/waliout<?php echo $par; ?>/<?php echo $kelas; ?>" class="nav-link <?php if($this->uri->segment(2)=="waliout<?php echo $par; ?>"){echo "active";}?>">
            <i class="nav-icon fas fa-share-square"></i><p>PD Keluar</p>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a href="<?php echo base_url('') ?>page/logout" class="nav-link"><i class="nav-icon fas fa-sign-out-alt"></i>
            <p>Log Out</p>
          </a>
        </li>
      </ul>
