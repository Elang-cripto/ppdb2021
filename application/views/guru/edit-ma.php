              ...
              <div class="card card-success">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                      <input type="text" name="kelas_7" class="form-control" id="kelas_7" placeholder="kelas_7" value="<?php echo $dbma->kelas_7; ?>">
                    </div>
                    <div class="col-sm-2">
                      <input type="text" name="kelas_8" class="form-control" id="kelas_8" placeholder="kelas_8"  value="<?php echo $dbma->kelas_8; ?>">
                    </div>
                    <div class="col-sm-2">
                      <input type="text" name="kelas_9" class="form-control" id="kelas_9" placeholder="kelas_9"  value="<?php echo $dbma->kelas_9; ?>">
                    </div>
                  </div>
                  <div class="form-group row">
