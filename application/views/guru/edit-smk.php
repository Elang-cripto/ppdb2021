  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- form start -->
        <form method="post" action="<?php echo base_url(); ?>guru/updatesmk" enctype="multipart/form-data">
            <!-- Horizontal Form -->
              ...
              <div class="card card-danger">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                      <input type="text" name="kelas_7" class="form-control" id="kelas_7" placeholder="kelas_7" value="<?php echo $dbsmk->kelas_7; ?>">
                    </div>
                    <div class="col-sm-2">
                      <input type="text" name="kelas_8" class="form-control" id="kelas_8" placeholder="kelas_8"  value="<?php echo $dbsmk->kelas_8; ?>">
                    </div>
                    <div class="col-sm-2">
                      <input type="text" name="kelas_9" class="form-control" id="kelas_9" placeholder="kelas_9"  value="<?php echo $dbsmk->kelas_9; ?>">
                    </div>
                  </div>
                  <div class="form-group row">
