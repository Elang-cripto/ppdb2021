     <div class="modal fade" id="modal-tambah">
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <form method="post" action="<?php echo base_url(); ?>ict/savekls" enctype="multipart/form-data">
      ...
      <div class="modal fade" id="modal-default-<?php echo $m->id;?>">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form method="post" action="<?php echo base_url(); ?>ict/editkls" enctype="multipart/form-data">
              <div class="modal-body">
                <div class="form-group row">
                    <label for="Username" class="col-sm-4 col-form-label">Nama Kelas</label>
                    <div class="col-sm-6">
