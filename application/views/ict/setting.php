      ...
      <!-- Default box -->
        <div class="col-md-6">
          <div class="card card-info">
            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url("ict/editset"); ?>">
              <div class="card-body">
...
<!--         <div class="col-md-6">
        ...
        <div class="col-md-6">  
          <form method="post" action="<?php echo base_url(); ?>ict/set_pengumuman" enctype="multipart/form-data">
