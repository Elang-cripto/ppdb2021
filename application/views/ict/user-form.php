              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="data1">
                    <form method="post" action="<?php echo base_url(); ?>ict/saveuser" enctype="multipart/form-data">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <select type="text" name="jabatan" id="jabatan" class="form-control select2" required>
                            <option value="" disabled selected hidden>-- Pilih Jabatan --</option>
                            <option value="guru">Guru</option>
                            <option value="walikelas">Wali Kelas</option>
                            <option value="ict">Tata Usaha</option>
                            <option value="headmaster">Kepala Sekolah</option>
                          </select>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="Jabatan" class="col-sm-2 col-form-label">Lembaga</label>
                        <div class="col-sm-10">
                          <select type="text" name="lembaga" id="lembaga" class="form-control select2">
