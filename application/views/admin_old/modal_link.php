     <div class="modal fade" id="modal-tambah">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form method="post" action="<?php echo base_url(); ?>admin/savelink" enctype="multipart/form-data">
...
<!-- ========================================================================================= -->
      <?php 
        foreach($dblink as $o):
      ?>
      <div class="modal fade" id="modal-verval-<?php echo $o->id;?>">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <form method="post" action="<?php echo base_url(); ?>admin/editlink" enctype="multipart/form-data">
              <div class="modal-body">
                <div class="form-group row">
