          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <form method="post" enctype="multipart/form-data" action="<?php echo base_url("admin/form/mts"); ?>">
          ...
          <div class="card card-primary">
            ...
            <?php
              if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form
                ...
                echo "<form method='post' action='".base_url("admin/import/mts")."'>";
                echo "<button type='submit' name='import' class='btn btn-primary'>Save</button>";
                echo "  ";
                echo "<button href='".base_url("admin")."' class='btn btn-danger'>Cancel</button><hr>";
