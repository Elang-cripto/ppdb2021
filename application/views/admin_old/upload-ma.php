          ...
          <div class="card card-success">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <form method="post" enctype="multipart/form-data" action="<?php echo base_url("admin/form/ma"); ?>">
            ...
            <div class="card-body">
              <div class="alert alert-info alert-dismissible">
                ...
                <p>File yang akan di Upload adalah file Excel yang sesuai dengan format dan ketentuan untuk menghindari error.</p> 
                  <button onclick="JavaScript:window.location.href='<?php echo base_url('') ?>asset/format.xlsx';" class="btn btn-block bg-gradient-warning">Download Format</button>
          ...
          <div class="card card-success">
            ...
            <?php
              if(isset($_POST['preview'])){ 
                ...
                echo "<form method='post' action='".base_url("admin/import/ma")."'>";
                echo "
