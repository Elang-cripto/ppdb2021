...
<!-- =============================================================================================== -->
                  ...
                  <tr>
                    ...
                    <td align="center">
                      <?php 
                        ...
                        $smkl = $this->db->query("SELECT * FROM db_smk where CONCAT(jk,kelas_aktf,status) LIKE '$clkls'")->num_rows();
                        echo $smkl;
                      ?>
                    </td>
                    <td align="center">
                      <?php 
                        ...
                        $smkp = $this->db->query("SELECT * FROM db_smk where CONCAT(jk,kelas_aktf,status) LIKE '$cpkls'")->num_rows();
                        echo $smkp;
                      ?>                      
                    </td>
                    <td align="center">
                    ...
                    <td align="center">
                      <a href="<?php echo base_url(); ?>admin/dataklssmk/<?php echo $row->kelas; ?>" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a>
                      ...
                      <a href="<?php echo base_url(); ?>admin/report_detail/<?php echo $row->par; ?>/<?php echo $row->kelas; ?>" class="btn btn-info btn-sm"><i class="fa fa-download"></i></a>
                      <a href="<?php echo base_url(); ?>admin/del_kls/<?php echo $row->id; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure to delete this record?')"><i class="fa fa-trash-alt"></i></a>                      
                    </td>
                    <td align="center">
  ...
  <!-- /.content-wrapper -->
<!-- =============================================================================================== -->
<?php $this->load->view('admin/modal_kls');  ?>
<!-- =============================================================================================== -->
<?php 
