  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- form start -->
        <form method="post" action="<?php echo base_url(); ?>admin/updatesmp" enctype="multipart/form-data">
            <!-- Horizontal Form -->
        <div class="row">
            <div class="col-md-3">
              <!-- Profile Image -->
              <div class="card card-warning card-outline">
                <div class="card-body box-profile">
                  ...
                  <ul class="list-group list-group-unbordered mb-3">
                    ...
                    <li class="list-group-item">
                      <b>ROMBEL</b> <a class="float-right"><h6><span class="badge bg-warning">Kelas <?php echo $dbsmp->kelas_aktf; ?></span></h6></a>
                    </li>
                    <li class="list-group-item">
                      <b>UMUR</b> 
                      <a class="float-right">
                  ...
                  <div class="card card-warning">
                    ...
                    <div class="card-body">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="no_kk" class="form-control" id="no_kk" value="<?php echo $dbsmp->no_kk; ?>" placeholder="Sesuai Kartu">
                        </div>
                      </div>
                      <div class="form-group row">
                  ...
                  <div class="card card-warning">
                    ...
                    <div class="card-body">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                          <input type="text" name="kelas_7" class="form-control" id="kelas_7" placeholder="7-X" value="<?php echo $dbsmp->kelas_7; ?>">
                        </div>
                        <div class="col-sm-2">
                          <input type="text" name="kelas_8" class="form-control" id="kelas_8" placeholder="8-X"  value="<?php echo $dbsmp->kelas_8; ?>">
                        </div>
                        <div class="col-sm-2">
                          <input type="text" name="kelas_9" class="form-control" id="kelas_9" placeholder="9-X"  value="<?php echo $dbsmp->kelas_9; ?>">
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <select type="text" name="status" id="status" onChange="opsi(this)" class="form-control select2">
                            ...
                            <option value="PROSES MUTASI" <?php if($dbsmp->status=="PROSES MUTASI"){echo "selected";} ?>>PROSES MUTASI</option>
                  ...
                  <div class="card card-warning">
                    ...
                    <div class="card-body">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <select type="text" name="ket_out" id="ket_out" disabled class="form-control select2" <?php if($dbsmp->status="NON AKTIF"){echo "";}else{echo "disabled";} ?>>
                            <option value="" <?php if($dbsmp->ket_out==""){echo "selected";} ?>></option>
                            <option value="Mutasi" <?php if($dbsmp->ket_out=="Mutasi"){echo "selected";} ?>>Mutasi</option>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <div class="input-group">
                            <input type="date" name="tgl_out" id="tgl_out" disabled class="form-control" value="<?php echo $dbsmp->tgl_out; ?>" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask <?php if($dbsmp->status="NON AKTIF"){echo "";}else{echo "disabled";} ?>>
                          </div>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="alasan_out" class="form-control" id="alasan_out" disabled value="<?php echo $dbsmp->alasan_out; ?>" <?php if($dbsmp->status="NON AKTIF"){echo "";}else{echo "disabled";} ?>>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="nosrt_out" class="col-sm-4 col-form-label">NO SURAT</label>
                        <div class="col-sm-8">
                          <input type="text" name="nosrt_out" class="form-control" id="nosrt_out" disabled value="<?php echo $dbsmp->nosrt_out; ?>" <?php if($dbsmp->status="NON AKTIF"){echo "";}else{echo "disabled";} ?>>
                        </div>
                      </div>
