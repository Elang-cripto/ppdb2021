                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a data-toggle='tooltip' data-placement='top' title='Profil' href="<?php echo base_url(); ?>mgm/view/<?php echo $tabel_cek; ?>/<?php echo ($row->id_enc); ?>" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a>
                                            <a data-toggle='tooltip' data-placement='top' title='Print' href="<?php echo base_url(); ?>mgm/bukti/<?php echo $tabel_cek; ?>/<?php echo ($row->id_enc); ?>" class="btn btn-warning btn-sm">
