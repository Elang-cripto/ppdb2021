          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="small-box bg-primary">
              <div class="inner">
                ...
                <h3>
                  <?php echo $this->db->get_where('db_mts', ["status" => 'AKTIF'])->num_rows(); ?>
                </h3>
              </div>
              <div class="icon">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="small-box bg-success">
              <div class="inner">
                ...
                <h3>
                  <?php echo $this->db->get_where('db_ma', ["status" => 'AKTIF'])->num_rows(); ?>
                </h3>
              </div>
              <div class="icon">
                <i class="fas fa-users"></i>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="small-box bg-warning">
              <div class="inner">
                ...
                <h3>
                  <?php echo $this->db->get_where('db_smp', ["status" => 'AKTIF'])->num_rows(); ?>
                </h3>
              </div>
              <div class="icon">
                <i class="fas fa-users"></i>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="small-box bg-danger">
              <div class="inner">
                ...
                <h3>
                  <?php echo $this->db->get_where('db_smk', ["status" => 'AKTIF'])->num_rows(); ?>
                </h3>
              </div>
              <div class="icon">
                <i class="fas fa-users"></i>
