  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
          <a class="btn btn-primary" href="<?php echo base_url('') ?>tatausaha/formmts"><i class="fa fa-user-plus"></i> Form Tambah PD</a><br><br>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td align="center">
                      ...
                      <a data-toggle='tooltip' data-placement='top' title='Edit' href="<?php echo base_url(); ?>tatausaha/editmts/<?php echo $row->id; ?>" class="btn btn-info btn-sm">
