          ...
          <div class="card card-success">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <form method="post" enctype="multipart/form-data" action="<?php echo base_url("tatausaha/form_ma"); ?>">
            ...
            <div class="card-body">
              <div class="alert alert-info alert-dismissible">
                ...
                <p>File yang akan di Upload adalah file Excel yang sesuai dengan format dan ketentuan untuk menghindari error.</p> 
                  <a type="button" href="../excel/format.xlsx" class="btn btn-block bg-gradient-warning">Download Format</a>
              </div>
            </div>
            <!-- /.card-body -->
          </div>
          ...
          <div class="card card-success">
            ...
            <?php
              if(isset($_POST['preview'])){ 
                ...
                echo "<form method='post' action='".base_url("tatausaha/import_ma")."'>";
                echo "
