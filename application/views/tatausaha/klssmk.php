...
<!-- =============================================================================================== -->
              ...
              <div class="card-body">
                ...
                <table class="table table-bordered">
                  ...
                  <tr>
                    ...
                    <td align="center">
                      <a href="<?php echo base_url(); ?>tatausaha/dataklssmk/<?php echo $row->kelas; ?>" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a>
  ...
  <!-- /.content-wrapper -->
<!-- =============================================================================================== -->
<?php $this->load->view('tatausaha/modal_kls');  ?>
<!-- =============================================================================================== -->
<?php 
