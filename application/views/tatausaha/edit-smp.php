  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- form start -->
        <form method="post" action="<?php echo base_url(); ?>tatausaha/updatesmp" enctype="multipart/form-data">
            <!-- Horizontal Form -->
        <div class="row">
            <div class="col-md-3">
              <!-- Profile Image -->
                ...
                <div class="col-md-6">
                  ...
                  <div class="card card-warning">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group row" <?php if($dbsmp->status=="AKTIF"){echo "hidden";} ?>>
                        <label for="status" class="col-sm-4 col-form-label">STATUS</label>
                        <div class="col-sm-8">
                          <select type="text" name="status" id="status" onChange="opsi(this)" class="form-control select2">
                            <option value="AKTIF" hidden <?php if($dbsmp->status=="AKTIF"){echo "selected disabled";} ?>>AKTIF</option>
                            ...
                            <option value="NON AKTIF" hidden <?php if($dbsmp->status=="NON AKTIF"){echo "selected";} ?>>NON AKTIF</option>
                          </select>
                        </div>
                      </div>
                  ...
                  <div class="card card-warning">
                    ...
                    <div class="card-body">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <select type="text" name="ket_out" id="ket_out"  class="form-control select2" <?php if($dbsmp->status="NON AKTIF"){echo "";}else{echo "disabled";} ?>>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <div class="input-group">
                            <input type="date" name="tgl_out" id="tgl_out" class="form-control" value="<?php echo $dbsmp->tgl_out; ?>" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask <?php if($dbsmp->status="NON AKTIF"){echo "";}else{echo "disabled";} ?>>
                            <div class="input-group-prepend">
                              <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                            </div>
                          </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="alasan_out" class="form-control" id="alasan_out" value="<?php echo $dbsmp->alasan_out; ?>" <?php if($dbsmp->status="NON AKTIF"){echo "";}else{echo "disabled";} ?>>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="nosrt_out" class="col-sm-4 col-form-label">NO SURAT</label>
                        <div class="col-sm-8">
                          <input type="text" name="nosrt_out" class="form-control" id="nosrt_out" value="<?php echo $dbsmp->nosrt_out; ?>" <?php if($dbsmp->status="NON AKTIF"){echo "";}else{echo "disabled";} ?>>
                        </div>
                      </div>
