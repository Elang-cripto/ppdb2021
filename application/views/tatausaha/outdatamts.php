                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td align="center">
                      ...
                      <a data-toggle='tooltip' data-placement='top' title='Print' href="<?php echo base_url(); ?>tatausaha/frame/sk_mts/mts/<?php echo $row->id; ?>" class="btn btn-warning btn-sm"><i class="fa fa-print"></i></a>
                    </td>
                  </tr>
                    <?php  endforeach; ?>
                  </tbody>
