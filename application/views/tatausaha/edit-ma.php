  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- form start -->
        <form method="post" action="<?php echo base_url(); ?>tatausaha/updatema" enctype="multipart/form-data">
            <!-- Horizontal Form -->
        <div class="row">
            <div class="col-md-3">
              <!-- Profile Image -->
                  ...
                  <div class="card card-success">
                    ...
                    <div class="card-body">              
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="lahir_ayh" class="form-control" id="lahir_ayh" placeholder="Lahir Ayah" value="<?php echo $dbma->lahir_ayh; ?>">
                        </div>
                      </div>
                      <div class="form-group row">
                  ...
                  <div class="card card-success">
                    ...
                    <div class="card-body">              
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="lahir_ibu" class="form-control" id="lahir_ibu" placeholder="Lahir Ibu" value="<?php echo $dbma->lahir_ibu; ?>">
                        </div>
                      </div>
                      <div class="form-group row">
                  ...
                  <div class="card card-success">
                    ...
                    <div class="card-body">              
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="lahir_wl" class="form-control" id="lahir_wl" placeholder="Lahir Wali" value="<?php echo $dbma->lahir_wl; ?>">
                        </div>
                      </div>
                      <div class="form-group row">
                  ...
                  <div class="card card-success">
                    ...
                    <div class="card-body">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                          <input type="text" name="kelas_7" class="form-control" id="kelas_7" placeholder="10-x" value="<?php echo $dbma->kelas_7; ?>">
                        </div>
                        <div class="col-sm-2">
                          <input type="text" name="kelas_8" class="form-control" id="kelas_8" placeholder="11-x"  value="<?php echo $dbma->kelas_8; ?>">
                        </div>
                        <div class="col-sm-2">
                          <input type="text" name="kelas_9" class="form-control" id="kelas_9" placeholder="12-x"  value="<?php echo $dbma->kelas_9; ?>">
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row" <?php if($dbma->status=="AKTIF"){echo "hidden";} ?>>
                        <label for="status" class="col-sm-4 col-form-label">STATUS</label>
                        <div class="col-sm-8">
                          <select type="text" name="status" id="status" onChange="opsi(this)" class="form-control select2">
                            <option value="AKTIF" hidden <?php if($dbma->status=="AKTIF"){echo "selected";} ?>>AKTIF</option>
                            ...
                            <option value="NON AKTIF" hidden <?php if($dbma->status=="NON AKTIF"){echo "selected";} ?>>NON AKTIF</option>
                          </select>
                        </div>
                      </div>
                  ...
                  <div class="card card-success">
                    ...
                    <div class="card-body">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <select type="text" name="ket_out" id="ket_out"  class="form-control select2" <?php if($dbma->status="NON AKTIF"){echo "";}else{echo "disabled";} ?>>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <div class="input-group">
                            <input type="date" name="tgl_out" id="tgl_out" class="form-control" value="<?php echo $dbma->tgl_out; ?>" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask <?php if($dbma->status="NON AKTIF"){echo "";}else{echo "disabled";} ?>>
                            <div class="input-group-prepend">
                              <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                            </div>
                          </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="alasan_out" class="form-control" id="alasan_out" value="<?php echo $dbma->alasan_out; ?>" <?php if($dbma->status="NON AKTIF"){echo "";}else{echo "disabled";} ?>>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="nosrt_out" class="col-sm-4 col-form-label">NO SURAT</label>
                        <div class="col-sm-8">
                          <input type="text" name="nosrt_out" class="form-control" id="nosrt_out" value="<?php echo $dbma->nosrt_out; ?>" <?php if($dbma->status="NON AKTIF"){echo "";}else{echo "disabled";} ?>>
                        </div>
                      </div>
