    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
                ...
                <div>
                  ...
                  <div class="timeline-item">
                    ...
                    <div class="timeline-footer">
                      ...
                      <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>headmaster/del_info/<?php echo $row->id; ?>">Delete</a>
                    </div>
                  </div>
                </div>
              <?php  endforeach; ?>
          ...
          <div class="col-md-6">  
            <form method="post" action="<?php echo base_url(); ?>headmaster/saveinfo" enctype="multipart/form-data">
              <div class="card card-info">
                ...
                <div class="row">
                  <div class="card-body">
                    ...
                    <button type="submit" class="btn btn-primary" href="<?php echo base_url('') ?>headmaster/saveinfo"><i class="fa fa-plus"></i> Tambah Info</button>
                  </div>
                </div>
              </div>
            </form>    
