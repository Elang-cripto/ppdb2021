          ...
          <div class="card card-danger">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <form method="post" enctype="multipart/form-data" action="<?php echo base_url("headmaster/form_smk"); ?>">
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      <button type="submit" name="preview" value="Preview" class="btn btn-danger">Preview</button>
                    </div>
                  </div>
                </form>
              </div>
          ...
          <div class="card card-danger">
            ...
            <?php
              if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form
                ...
                echo "<form method='post' action='".base_url("headmaster/import_smk")."'>";
