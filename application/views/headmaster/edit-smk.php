  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- form start -->
        <form method="post" action="<?php echo base_url(); ?>headmaster/updatesmk" enctype="multipart/form-data">
            <!-- Horizontal Form -->
        <div class="row">
            <div class="col-md-3">
              <!-- Profile Image -->
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <select type="text" name="status" id="status" onChange="opsi(this)" class="form-control select2">
                            ...
                            <option value="NON AKTIF" <?php if($dbsmk->status=="NON AKTIF"){echo "selected";} ?>>NON AKTIF</option>
                          </select>
                        </div>
                      </div>
