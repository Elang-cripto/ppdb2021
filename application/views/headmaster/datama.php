        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-success">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <a class="btn btn-secondary" href="<?php echo base_url('') ?>headmaster/formma"><i class="fa fa-user-plus"></i> Form Tambah Siswa</a><hr>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td align="center">
                      ...
                      <a data-toggle='tooltip' data-placement='top' title='Edit' href="<?php echo base_url(); ?>headmaster/editma/<?php echo $row->id; ?>" class="btn btn-info btn-sm">
