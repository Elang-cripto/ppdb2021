                  ...
                  <tr>
                    ...
                    <td align="center">
                      <?php 
                        ...
                        $mal = $this->db->query("SELECT * FROM db_mts where CONCAT(jk,kelas_aktf,status) LIKE '$clkls'")->num_rows();
                        echo $mal;
                      ?>
                    </td>
                    <td align="center">
                      <?php 
                        ...
                        $map = $this->db->query("SELECT * FROM db_mts where CONCAT(jk,kelas_aktf,status) LIKE '$cpkls'")->num_rows();
                        echo $map;
                      ?>                      
                    </td>
                    <td align="center">
                    ...
                    <td align="center">
                      <a href="<?php echo base_url(); ?>headmaster/dataklssmp/<?php echo $row->kelas; ?>" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a>
