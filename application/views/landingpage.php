...
<head>
    ...
    <!-- Favicons -->
    <link href="<?php echo base_url(); ?>asset/frontend/image/LOGO YAYASAN.png" rel="icon">
    <link href="<?php echo base_url(); ?>asset/dist/img/landing/apple-touch-icon.png" rel="apple-touch-icon">
    ...
    <link href="<?php echo base_url(); ?>asset/dist/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>asset/dist/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">
...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center justify-content-between">
            <div class="d-flex">
                <h1 class="logo pr-4"><img src="<?php echo base_url(); ?>asset/frontend/image/LOGO YAYASAN.png"></h1>
                <h1 class="logo pt-2">AL AMIEN</h1>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <h1>PPDB YAYASAN PONDOK PESANTREN AL AMIEN</h1>
                    <h2 style="font-family: Arial, Helvetica, sans-serif;">Panitia Penerimaan Peserta Didik Baru
    ...
    <main id="main">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0 content">
                        ...
                        <p class="fst-italic">
                            Pendaftaran Yang telah dibuka meliputi Pondok Pesantren dan 4 Lembaga Formal Di Yayasan Pondok Pesantren Al Amien Ambulu di antaranya adalah :
                        </p>
                        <ul>
                            <li><i class="bi bi-check-circle"></i> Madrasah Tsanawiyah Al Amien</li>
                            <li><i class="bi bi-check-circle"></i> SMP Plus Al Amien</li>
                            <li><i class="bi bi-check-circle"></i> Madrasah Aliyah Al Amien</li>
        ...
        <section id="team" class="team section-bg">
            <div class="container">
                ...
                <div class="section-title">
                    <span>Prestasi AL AMIEN</span>
                    <h2>Prestasi AL AMIEN</h2>
        ...
        <section id="contact" class="contact">
            <div class="container">
                ...
                <div class="section-title">
                    <span>Kontak</span>
                    <h2>Kontak</h2>
                    <p>Informasi lebih jelas Mengenai Lembaga dan PPDB AL AMIEN bisa kontak salah satu nomor di bawah ini <br> atau dapat langsung mengunjungi kantor pada peta di bawah ini</p>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 d-flex align-items-stretch">
                        <div class="info">
                            ...
                            <div class="email">
                                ...
                                <h4>Email:</h4>
                                <p>alamienjember@gmail.com</p>
                            </div>

                            <div class="phone">
                                <i class="bi bi-phone"></i>
                                <h4>Contact Person:</h4>
                                <p>(Untuk Telp dan Whatsapp) <br> Bapak Abdul Hamid 085 285 746 828 <br> Bapak Arif Nurdiansyah 082 233 126 247</p>
                            </div>
                    ...
                    <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3947.3862784886137!2d113.5992159145077!3d-8.363608293984107!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd69b0ae38a73fd%3A0x75d91097a6b6b819!2sPondok%20Pesantren%20Al%20Amien!5e0!3m2!1sid!2sid!4v1641964303687!5m2!1sid!2sid" frameborder="0" style="border:0; width: 100%; height: 290px;" allowfullscreen></iframe>
                    </div>
    ...
    <!-- Vendor JS Files -->
    <script src="<?php echo base_url(); ?>asset/dist/vendor/purecounter/purecounter.js"></script>
    <script src="<?php echo base_url(); ?>asset/dist/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="<?php echo base_url(); ?>asset/dist/vendor/glightbox/js/glightbox.min.js"></script>
    <script src="<?php echo base_url(); ?>asset/dist/vendor/isotope-layout/isotope.pkgd.min.js"></script>
    <script src="<?php echo base_url(); ?>asset/dist/vendor/swiper/swiper-bundle.min.js"></script>
    <script src="<?php echo base_url(); ?>asset/dist/vendor/php-email-form/validate.js"></script>
