    ...
    <div class="modal fade" id="modal-tambah">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form name="form_tambah" method="post" action="<?php echo base_url(); ?>admin/adduser_pes" enctype="multipart/form-data" onsubmit="return cekform()">
      ...
      <div class="modal fade" id="modal-user-<?php echo md5($m->id); ?>">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form method="post" action="<?php echo base_url(); ?>admin/edituser_pes" enctype="multipart/form-data">
              <div class="modal-body">
                <div class="form-group row">
                  <label for="nik" class="col-sm-4 col-form-label">NIK</label>
                  <div class="col-sm-6">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <select type="text" name="par" id="par" class="form-control select2" required>
                      <option value="MTS" <?php if ($m->par == "MTS") {
                                            echo "selected";
                                          } ?>>MTS AL AMIEN</option>
                      <option value="MA" <?php if ($m->par == "MA") {
                                            echo "selected";
                                          } ?>>MA AL AMIEN</option>
                      <option value="SMP" <?php if ($m->par == "SMP") {
                                            echo "selected";
                                          } ?>>SMP PLUS AL AMIEN</option>
                      <option value="SMK" <?php if ($m->par == "SMK") {
                                            echo "selected";
                                          } ?>>SMK AL AMIEN</option>
                    </select>
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <select type="text" name="status" id="status" class="form-control select2">
                      <option value="NON AKTIF" <?php if ($m->status == "NON AKTIF") {
                                                  echo "selected";
                                                } ?>>NON AKTIF</option>
                      <option value="AKTIF" <?php if ($m->status == "AKTIF") {
                                              echo "selected";
                                            } ?>>AKTIF</option>
                    </select>
                  </div>
