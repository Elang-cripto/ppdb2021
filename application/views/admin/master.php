                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="upload-mts" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                    <!-- <div class="alert alert-info alert-dismissible">
                      ...
                      mengupload data excel.
                    </div>   -->
                      <a href="<?php echo base_url('') ?>admin/upload/mts" class="btn btn-app" >
                        <i class="fas fa-upload"></i> Upload Data MTS
                      </a>
                      <a href="<?php echo base_url('') ?>admin/export/mts" class="btn btn-app" >
                        <i class="fas fa-download"></i> Download Data MTS
                      </a>
                      <a href="<?php echo base_url('') ?>admin/backup/mts" class="btn btn-app" >
                        <i class="fas fa-download"></i> Backup Data MTS
                      </a>
                  </div>
                  <div class="tab-pane fade" id="upload-ma" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
                    <!-- <div class="alert alert-success alert-dismissible">
                      ...
                      <a href="<?php echo base_url('') ?>admin/upload/ma" class="btn btn-app" >
                        <i class="fas fa-upload"></i> Upload Data MA
                      </a>
                      <a href="<?php echo base_url('') ?>admin/export/ma" class="btn btn-app" >
                        <i class="fas fa-download"></i> Download Data MA
                      </a>
                      <a href="<?php echo base_url('') ?>admin/backup/ma" class="btn btn-app" >
                        <i class="fas fa-download"></i> Backup Data MA
                      </a>
                  </div>
                  <div class="tab-pane fade" id="upload-smp" role="tabpanel" aria-labelledby="custom-tabs-one-messages-tab">
                    ...
                    <a href="<?php echo base_url('') ?>admin/upload/smp" class="btn btn-app" >
                      <i class="fas fa-upload"></i> Upload Data SMP
                    </a>
                    <a href="<?php echo base_url('') ?>admin/export/smp" class="btn btn-app" >
                      <i class="fas fa-download"></i> Download Data SMP
                    </a>
                    <a href="<?php echo base_url('') ?>admin/backup/smp" class="btn btn-app" >
                        <i class="fas fa-download"></i> Backup Data SMP
                      </a>
                  </div>
                  <div class="tab-pane fade" id="upload-smk" role="tabpanel" aria-labelledby="custom-tabs-one-settings-tab">
                    ...
                    <a href="<?php echo base_url('') ?>admin/upload/smk" class="btn btn-app" >
                      <i class="fas fa-upload"></i> Upload Data SMK
                    </a>
                    <a href="<?php echo base_url('') ?>admin/export/smk" class="btn btn-app" >
                      <i class="fas fa-download"></i> Download Data SMK
                    </a>
                    <a href="<?php echo base_url('') ?>admin/backup/smk" class="btn btn-app" >
                        <i class="fas fa-download"></i> Backup Data SMK
                    </a>
                  </div>
                </div>
              </div>
